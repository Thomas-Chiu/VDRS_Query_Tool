...
class Log
{
  ...
  public function getLog()
  {
    // create query
    if ($this->devEnv) {
      $query = "SELECT * FROM `vdrs_v2`.`$this->table$_POST[busId]` WHERE `date_time` BETWEEN '$_POST[startDate] $_POST[startTime]' AND '$_POST[endDate] $_POST[endTime]' ORDER BY `date_time`";
    } else {
